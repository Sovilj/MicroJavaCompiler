...
public class TableDump extends SymbolTableVisitor {

	//KOPIRAN DUMPSYMBOLTABLE IZ DATE BIBLIOTEKE I DODATO PAR STVARI
	...
	public void visitStructNode(Struct structToVisit) {
		...
		case Struct.Enum:				//DODATO
			output.append("enum");
			break;
		case Struct.Bool:				//DODATO
			output.append("bool");
			break;
		case Struct.None:
